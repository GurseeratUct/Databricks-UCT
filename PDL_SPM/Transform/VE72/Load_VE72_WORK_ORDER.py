...
# MAGIC %sql
# MAGIC MERGE INTO VE72.WORK_ORDER as T
# MAGIC USING (select * from (select RANK() OVER (PARTITION BY TYPE,BASE_ID,LOT_ID,SPLIT_ID,SUB_ID ORDER BY LandingFileTimeStamp DESC) as rn,* from stg_WORK_ORDER)A where A.rn = 1) as S 
