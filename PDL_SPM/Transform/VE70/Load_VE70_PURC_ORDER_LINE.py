...
# MAGIC %sql
# MAGIC MERGE INTO VE70.PURC_ORDER_LINE as T
# MAGIC USING (select * from (select ROW_NUMBER() OVER (PARTITION BY PURC_ORDER_ID,LINE_NO ORDER BY LandingFileTimeStamp DESC) as rn,* from stg_PURC_ORDER_LINE)A where A.rn = 1 ) as S 
